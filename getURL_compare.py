...
def getURL_compare(word):
    options = Options()
    # ブラウザ立ち上げを無効にする
    # options.set_headless(True)

    searchurl = 'https://app.mieru-ca.com/faber-extract/word-related-compare'
    ...
    while True:
        try:
            targeturl = driver.find_elements_by_xpath('//*[@id="tbody_result"]/tr[1]/td[4]/a')[0].get_attribute(
                'href')
            break
        except IndexError:
            time.sleep(60)
